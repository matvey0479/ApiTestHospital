...
using ApiTest.Domain.Repositories.EntityFramework;
...
builder.Services.AddScoped<IPatientsRepository, EFPatientRepository>();
builder.Services.AddScoped<IDoctorsRepository,EFDoctorsRepository>();
